...
class FormController extends Controller
{
    ...
    public function pdf()
    {
        try {
            ...
            $pdf->SetFont('Times', '', '10');
            $pdf->Cell(0, 10, 'Dengan ini diberitahukan bahwa peserta seleksi penerimaan Siswa baru telah dinyatakan ', 0, 1, 'C');
            ...
            $pdf->SetFont('Times', '', '10');
            $pdf->SetTextColor(0);
            $pdf->Cell(0, 10, 'Peserta yang dinyatakan lulus seleksi penerimaan Siswa baru diharapkan untuk segera melakukan ', 0, 0, 'L');
            $pdf->ln($beetwen_note);
            $pdf->Cell(0, 10, '1. Pembayaran registrasi Siswa baru yang dinyatakan lulus', 0, 0, 'L');
            $pdf->ln($beetwen_note);
            $pdf->Cell(0, 10, '2. Lakukan pembayaran mahasiwa baru ke ' . $core->payment_bank . ' - ' . $core->payment_name, 0, 0, 'L');
            $pdf->ln($beetwen_note);
            $pdf->Cell(0, 10, '3. Bagi Siswa baru yang telah melakukan pembayaran agar menyerahkan bukti pembayaran ke bagian keuangan ', 0, 0, 'L');
            $pdf->ln($beetwen_note);
            $pdf->SetX(23);
            $pdf->Cell(0, 10, $core->institution_name, 0, 0, 'L');
            $pdf->ln($beetwen_note);
            $pdf->Cell(0, 10, '4. Bagi Siswa baru yang tidak melakukan registrasi pada tanggal yang telah ditentukan dianggap mengundurkan diri ', 0, 0, 'L');
