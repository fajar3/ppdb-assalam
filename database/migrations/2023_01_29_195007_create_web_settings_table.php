...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        DB::table('web_settings')->insert([
            'name' => 'Assalam',
            'site_name' => 'PMB Assalam',
            'short_name' => 'PMB Assalam',
            'institution_name' => 'Yayasan Assalam',
            'institution_short_name' => 'Yayasan Assalam',
            'institution_synopsis' => 'Yayasan Assalam mempunyai tata nilai budaya akademik yang khas yaitu BERTUAH mempunyai makna bahwa setiap lulusan Universitas Hang Tuah Pekanbaru harus memiliki kualifikasi',
            ...
            'title_home' => 'Yayasan Assalam',
            'title_dashboard' => 'PMB',
            'title_exam' => 'CBT',
            'footer' => '© 2025 Yayasan Assalam',
            'contact_telp' => '081234567890',
            'contact_email' => 'admin@gmail.com',
            'contact_fax' => '+ 0761 33815',
            'contact_address' => 'JL. Raya Sukosari, 65179, Sukosari Dua, Balearjo, Rejoyoso, Bantur, Malang, Kabupaten Malang, Jawa Timur 65174',
